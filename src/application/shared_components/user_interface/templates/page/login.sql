...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(8882606102377771)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8882982840377772)
,p_page_template_id=>wwv_flow_imp.id(8882606102377771)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8883258772377772)
,p_page_template_id=>wwv_flow_imp.id(8882606102377771)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8883560973377772)
,p_page_template_id=>wwv_flow_imp.id(8882606102377771)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8883877731377772)
,p_page_template_id=>wwv_flow_imp.id(8882606102377771)
,p_name=>'Body Footer'
