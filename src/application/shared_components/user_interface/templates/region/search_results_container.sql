...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8923019900377799)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8923381374377800)
,p_plug_template_id=>wwv_flow_imp.id(8923019900377799)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8923671836377800)
,p_plug_template_id=>wwv_flow_imp.id(8923019900377799)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8923969272377800)
,p_plug_template_id=>wwv_flow_imp.id(8923019900377799)
,p_name=>'Sub Regions'
