...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8961150118377820)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8961490739377820)
,p_plug_template_id=>wwv_flow_imp.id(8961150118377820)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8961750373377820)
,p_plug_template_id=>wwv_flow_imp.id(8961150118377820)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8962093412377820)
,p_plug_template_id=>wwv_flow_imp.id(8961150118377820)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8962331294377821)
,p_plug_template_id=>wwv_flow_imp.id(8961150118377820)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8962674268377821)
,p_plug_template_id=>wwv_flow_imp.id(8961150118377820)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8962991041377821)
,p_plug_template_id=>wwv_flow_imp.id(8961150118377820)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8963225448377821)
,p_plug_template_id=>wwv_flow_imp.id(8961150118377820)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8963563091377821)
,p_plug_template_id=>wwv_flow_imp.id(8961150118377820)
,p_name=>'Sub Regions'
