...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8968770658377824)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8969047586377824)
,p_plug_template_id=>wwv_flow_imp.id(8968770658377824)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8969396803377824)
,p_plug_template_id=>wwv_flow_imp.id(8968770658377824)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8969677260377824)
,p_plug_template_id=>wwv_flow_imp.id(8968770658377824)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8969988555377824)
,p_plug_template_id=>wwv_flow_imp.id(8968770658377824)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8970201430377825)
,p_plug_template_id=>wwv_flow_imp.id(8968770658377824)
,p_name=>'Sub Regions'
