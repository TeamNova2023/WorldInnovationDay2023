...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8896241041377780)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8896535917377780)
,p_plug_template_id=>wwv_flow_imp.id(8896241041377780)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8896863617377780)
,p_plug_template_id=>wwv_flow_imp.id(8896241041377780)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8897141449377785)
,p_plug_template_id=>wwv_flow_imp.id(8896241041377780)
,p_name=>'Sub Regions'
