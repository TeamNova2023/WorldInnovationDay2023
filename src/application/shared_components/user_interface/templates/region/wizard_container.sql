...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8976687834377828)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8976915301377828)
,p_plug_template_id=>wwv_flow_imp.id(8976687834377828)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8977289736377828)
,p_plug_template_id=>wwv_flow_imp.id(8976687834377828)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8977501122377828)
,p_plug_template_id=>wwv_flow_imp.id(8976687834377828)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8977886956377829)
,p_plug_template_id=>wwv_flow_imp.id(8976687834377828)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8978191613377829)
,p_plug_template_id=>wwv_flow_imp.id(8976687834377828)
