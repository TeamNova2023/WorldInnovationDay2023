...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8956917941377817)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8957238556377817)
,p_plug_template_id=>wwv_flow_imp.id(8956917941377817)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8957590007377817)
,p_plug_template_id=>wwv_flow_imp.id(8956917941377817)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8957806480377818)
,p_plug_template_id=>wwv_flow_imp.id(8956917941377817)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8958180744377818)
,p_plug_template_id=>wwv_flow_imp.id(8956917941377817)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8958409638377818)
,p_plug_template_id=>wwv_flow_imp.id(8956917941377817)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8958744292377818)
,p_plug_template_id=>wwv_flow_imp.id(8956917941377817)
,p_name=>'Sub Regions'
