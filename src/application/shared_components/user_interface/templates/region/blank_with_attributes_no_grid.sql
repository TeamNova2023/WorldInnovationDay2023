...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8894818384377779)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8895124048377779)
,p_plug_template_id=>wwv_flow_imp.id(8894818384377779)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8895492734377780)
,p_plug_template_id=>wwv_flow_imp.id(8894818384377779)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8895788963377780)
,p_plug_template_id=>wwv_flow_imp.id(8894818384377779)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8896097617377780)
,p_plug_template_id=>wwv_flow_imp.id(8894818384377779)
,p_name=>'Sub Regions'
