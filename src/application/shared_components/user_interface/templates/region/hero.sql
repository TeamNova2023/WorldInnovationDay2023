...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8965591163377822)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8965832135377822)
,p_plug_template_id=>wwv_flow_imp.id(8965591163377822)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8966135370377822)
,p_plug_template_id=>wwv_flow_imp.id(8965591163377822)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8966415322377823)
,p_plug_template_id=>wwv_flow_imp.id(8965591163377822)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8966753785377823)
,p_plug_template_id=>wwv_flow_imp.id(8965591163377822)
,p_name=>'Sub Regions'
