...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8935548008377805)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8935847357377806)
,p_plug_template_id=>wwv_flow_imp.id(8935548008377805)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8936149634377806)
,p_plug_template_id=>wwv_flow_imp.id(8935548008377805)
,p_name=>'Tabs'
