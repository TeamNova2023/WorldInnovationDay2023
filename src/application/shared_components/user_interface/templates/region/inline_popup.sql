...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8971240372377825)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8971526072377825)
,p_plug_template_id=>wwv_flow_imp.id(8971240372377825)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8971885840377826)
,p_plug_template_id=>wwv_flow_imp.id(8971240372377825)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8972184343377826)
,p_plug_template_id=>wwv_flow_imp.id(8971240372377825)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8972487873377826)
,p_plug_template_id=>wwv_flow_imp.id(8971240372377825)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8972714875377826)
,p_plug_template_id=>wwv_flow_imp.id(8971240372377825)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8973084208377826)
,p_plug_template_id=>wwv_flow_imp.id(8971240372377825)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8973350173377826)
,p_plug_template_id=>wwv_flow_imp.id(8971240372377825)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8973626732377826)
,p_plug_template_id=>wwv_flow_imp.id(8971240372377825)
,p_name=>'Sub Regions'
