...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8913678196377795)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8913978625377795)
,p_plug_template_id=>wwv_flow_imp.id(8913678196377795)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8914211801377795)
,p_plug_template_id=>wwv_flow_imp.id(8913678196377795)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8914583855377795)
,p_plug_template_id=>wwv_flow_imp.id(8913678196377795)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8914897968377795)
,p_plug_template_id=>wwv_flow_imp.id(8913678196377795)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8915100238377795)
,p_plug_template_id=>wwv_flow_imp.id(8913678196377795)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8915407939377796)
,p_plug_template_id=>wwv_flow_imp.id(8913678196377795)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8915740374377796)
,p_plug_template_id=>wwv_flow_imp.id(8913678196377795)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8916072409377796)
,p_plug_template_id=>wwv_flow_imp.id(8913678196377795)
,p_name=>'Sub Regions'
