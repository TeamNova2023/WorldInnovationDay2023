...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8893483361377779)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8893738407377779)
,p_plug_template_id=>wwv_flow_imp.id(8893483361377779)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8894047004377779)
,p_plug_template_id=>wwv_flow_imp.id(8893483361377779)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8894304722377779)
,p_plug_template_id=>wwv_flow_imp.id(8893483361377779)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8894621438377779)
,p_plug_template_id=>wwv_flow_imp.id(8893483361377779)
,p_name=>'Sub Regions'
