...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8918448744377797)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8918712622377797)
,p_plug_template_id=>wwv_flow_imp.id(8918448744377797)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8919042564377797)
,p_plug_template_id=>wwv_flow_imp.id(8918448744377797)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8919312208377797)
,p_plug_template_id=>wwv_flow_imp.id(8918448744377797)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8919647154377797)
,p_plug_template_id=>wwv_flow_imp.id(8918448744377797)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8919934722377798)
,p_plug_template_id=>wwv_flow_imp.id(8918448744377797)
,p_name=>'Sub Regions'
