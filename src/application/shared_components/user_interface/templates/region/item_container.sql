...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8920590284377798)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8920812213377798)
,p_plug_template_id=>wwv_flow_imp.id(8920590284377798)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8921169566377798)
,p_plug_template_id=>wwv_flow_imp.id(8920590284377798)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8921445275377798)
,p_plug_template_id=>wwv_flow_imp.id(8920590284377798)
,p_name=>'Button Start'
