...
@@workspace/credentials/credentials_for_openai_2.sql
...
@@application/shared_components/files/icon_final_png.sql
...
@@application/shared_components/user_interface/lovs/company_name.sql
